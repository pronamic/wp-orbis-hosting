...
<table class="form-table">
	<tbody>
		<tr>
			<th scope="row">
				<label for="orbis_hosting_group_ip_address"><?php _e( 'IP address', 'orbis' ); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<label for="orbis_hosting_group_hostname"><?php _e( 'Hostname', 'orbis' ); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<label for="orbis_hosting_group_hostname_provider"><?php _e( 'Hostname Provider', 'orbis' ); ?></label>
			</th>
			<td>

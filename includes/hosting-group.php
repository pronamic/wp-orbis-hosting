...
function orbis_hosting_group_column( $column, $post_id ) {
	switch ( $column ) {
		case 'orbis_hosting_group_ip_address':
			echo wp_kses_post( get_post_meta( $post_id, '_orbis_hosting_group_ip_address', true ) );

			break;
		case 'orbis_hosting_group_hostname':
			echo wp_kses_post( get_post_meta( $post_id, '_orbis_hosting_group_hostname', true ) );

			break;
		case 'orbis_hosting_group_hostname_provider':
			echo wp_kses_post( get_post_meta( $post_id, '_orbis_hosting_group_hostname_provider', true ) );
